...
export class PLYExporter {
    ...
    parse(object, onDone, options: any = {}) {
        ...
        let includeNormals: boolean = false;
        ...
        if (includeNormals as boolean === true) {
        ...
        if (includeColors as boolean === true) {
